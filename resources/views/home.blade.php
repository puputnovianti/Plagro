...
<body>
    ...
    <section id="nav">
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container">
                <a class="navbar-brand" href="#"><span>Plagro.id</span></a>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="https://plagro.id/">Shop</a>
                        </li>
                        <li class="nav-item">
    ...
    <section id="banner">
        <div class="banner">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <h1 class="display-4 fw-bold title">Plagro.id</h1>
                        <p class="lead fw-normal">Bergabung menjadi mitra outlet kami.<br>Plagro.id menawarkan produk pertanian yang berkualitas.</p>
                        <a class="btn btn-warning text-white" href="register" style="border-radius: 25px;">Daftar Sekarang</a>
                    </div>
                    <div class="col-md-6">
                        <img src="img/banner.png" alt="" class="ban-img img-fluid">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="mitra">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <img src="img/Opened-bro.png" alt="" class="mi-img img-fluid">
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="features">
        <div class="container">
            <h2 class="text-center">Apa yang kami tawarkan?</h2>
            <div class="row text-center">
                <div class="col-md-4 features">
                    <h4>Produk Berkualitas</h4>
                    <svg class="my-3" xmlns="http://www.w3.org/2000/svg" width="80" height="80" fill="currentColor" class="bi bi-award" viewBox="0 0 16 16">
                ...
                <div class="col-md-4 features">
                    ...
                    <svg class="my-3" xmlns="http://www.w3.org/2000/svg" width="80" height="80" fill="currentColor" class="bi bi-cash-coin" viewBox="0 0 16 16">
    ...
    <footer class="p-5 bg-success text-white">
        <div class="row justify-content-center bg-success text-center">
            <div class="col-md-3">
                <img src="img/logo.png" style="width: 120px;" alt="plagro.id">
            </div>
            <div class="col-md-3">
                <h5>Hubungi Kami</h5>
                <ul class="list-unstyled text-small">
                    <li><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-envelope" viewBox="0 0 16 16">
                        ...
                        </svg><a class="link-secondary text-white" href="#"> plagro.id@gmail.com</a></li>
                    <li><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-whatsapp" viewBox="0 0 16 16">
                        ...
                        </svg><a class="link-secondary text-white" href="#"> 081 236 958 275</a></li>
                    <li><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16">
                        ...
                        </svg><a class="text-white" href="https://www.instagram.com/plagro.id/"> plagro.id</a></li>
                </ul>
            </div>
    </footer>
